...
export default function ShowcaseDashboard({ onAuthClick }) {
  ...
  return (
    <div className="showcase animate-in">
      ...
      <section id="overview" className="show-hero">
        <div>
          ...
          <div className="show-cta">
            <button className="btn" onClick={onAuthClick}>Login / Sign up</button>
            <button className="btn ghost" onClick={scrollToHow}>View how it works</button>
          </div>
        </div>
